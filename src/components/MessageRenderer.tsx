        ...
        <div className="border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm">
            ...
            {isExpanded && (
                <div className="p-4 overflow-x-auto">
                    <pre className="text-xs text-gray-700 bg-gray-100 p-3 rounded border border-gray-200 whitespace-pre-wrap break-words">
                        {query}
                    </pre>
                </div>
            )}
                ...
                <div className="prose prose-sm break-words">
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            pre: ({ node, ...props }) => (
                                <pre className="overflow-x-auto w-full bg-gray-100 p-2 rounded text-xs" {...props} />
                            ),
                        }}
                    >
                        {text}
